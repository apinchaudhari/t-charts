<html lang="{{ app()->getLocale() }}">
    ...
    @include('superadmin.partials.auth.head')

    <body class="login-page superadmin">
        @stack('body_start')
                    ...
                    <div class="header-body text-center">
                        <div class="row justify-content-center">
                            <div class="col-xl-5 col-lg-6 col-md-8">
                                <img class="mb-5" src="{{ asset('public/img/akaunting-logo-white.svg') }}" width="70%" alt="T-Charts"/>
                            </div>
                        </div>
                    </div>
                </div>
