 ...
 */
     ...
     */ 
         ...
         * @static 
         */ 
        public static function api($alias, $routes, $attrs = [])
        {
                        return \Illuminate\Routing\Router::api($alias, $routes, $attrs);
        }
                    /**
         * 
         *
...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function defineVariant($variantName, $manipulation)
        {
                        /** @var \Plank\Mediable\ImageManipulator $instance */
                        return $instance->defineVariant($variantName, $manipulation);
        }
                    /**
         * 
         *
         ...
         * @return \Plank\Mediable\ImageManipulation 
