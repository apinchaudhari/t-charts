...
use App\Models\Superadmin\Common\Dashboard;
use App\Models\Superadmin\Common\Widget;
...
class Dashboards extends Controller
{
    ...
    public function index()
    {
        ...
        return $this->response('superadmin.common.dashboards.index', compact('dashboards'));
    }
    ...
    public function show($dashboard_id = null)
    {
        ...
        return view('superadmin.common.dashboards.show', compact('dashboard', 'widgets', 'date_picker_shortcuts'));
    }
    ...
    public function create()
    {
        ...
        return view('superadmin.common.dashboards.create', compact('users'));
    }
    ...
    public function edit(Dashboard $dashboard)
    {
        ...
        return view('superadmin.common.dashboards.edit', compact('dashboard', 'users'));
    }
